...
//  EmojiReader
//
//  Created by Dmitrii Abanin on 7/7/20.
...
class EmojiTableViewController: UITableViewController {
    ...
    var objects = [
        Emoji(emoji: "🌚", name: "Dark moon", description: "Darkness is beautiful", isFavourite: false),
        Emoji(emoji: "🏓", name: "Ping-pong", description: "Sport!", isFavourite: false),
        Emoji(emoji: "🎭", name: "Masks", description: "Sad or happy?", isFavourite: false)
    ]
